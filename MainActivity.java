...
public class MainActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectPicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(photoPickerIntent, SELECT_PHOTO);//resmi seçiyoruz.
                imgNo = 1;
            }
    ...
    public void onCameraViewStarted(int width, int height) {
       ...
       // mCurrentFrame=new Mat(height,width,CvType.CV_8SC4);
   ...
   /* public void featureDetector(){
        FeatureDetector orbDetector=new FeatureDetector. create(FeatureDetector.ORB);
